/* Name: Starkely Coord Generator
 * Description: Creates the coords for Hyperbolic paraboloid.
 * Author: Larry Gaitan-Rodriguez, Robert Weinmann, Ariana Hall-Lagos of HWG Associates.
 * Creation: 7/3/19
 * EDITS:
 * 1) 7/3/19 Created File write.
 * 2) Named it the Starkely Coord Generator after that one beatle guy who draws MS Paint pictures. 
 */
...
public class starkely
{
  ...
  {
    //Welcome
    System.out.println("Starkely Coord Generator for a Hyperbolic Paraboloid"); 
   ...
   try{    
      ...
      FileWriter inscriber =new FileWriter("HP_Coords.SCR");
      ...
      {
        System.out.println("Lines of coordinates generated: "+count);
        y_plane = rangeLeft;
